...
## Описание программы
GitGenie — это удобное настольное приложение для macOS, которое автоматизирует создание минимальных изменений в ваших локальных Git-репозиториях, выполнение коммитов и пушей в удалённые репозитории. Оно идеально подходит для разработчиков, желающих автоматизировать рутинные задачи Git и отслеживать статистику коммитов. 🚀
